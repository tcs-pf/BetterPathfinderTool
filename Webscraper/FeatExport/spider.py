...
class RaceSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        filename = "races-" + pagetitle
        completeName = os.path.join("./Exports/", filename)
        with open("export-%s.txt"%completeName, "w") as file:
        ...
        for line in resp:
            if "http://www.d20pfsrd.com/races" in line and not pagetitle in line and len(line.split("/")) == 7:
